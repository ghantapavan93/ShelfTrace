...
> prototype with 131 PostgreSQL-backed tests.
...
- **No fabricated numbers.** Only claim what the repo actually proves
  (current: 131 PostgreSQL-backed tests, configurable scenario engine,
...
- **Backend tests must stay green.** 131/131 on real Postgres is the floor.
