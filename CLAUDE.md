...
> prototype with 410 PostgreSQL-backed tests.
...
- **No fabricated numbers.** Only claim what the repo actually proves
  (current: 410 PostgreSQL-backed tests, configurable scenario engine,
...
- **Backend tests must stay green.** 410/410 on real Postgres is the floor.
