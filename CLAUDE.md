...
> prototype with 409 PostgreSQL-backed tests.
...
- **No fabricated numbers.** Only claim what the repo actually proves
  (current: 409 PostgreSQL-backed tests, configurable scenario engine,
...
- **Backend tests must stay green.** 409/409 on real Postgres is the floor.
