...
> prototype with 395 PostgreSQL-backed tests.
...
- **No fabricated numbers.** Only claim what the repo actually proves
  (current: 395 PostgreSQL-backed tests, configurable scenario engine,
...
- **Backend tests must stay green.** 395/395 on real Postgres is the floor.
