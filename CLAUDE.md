...
> prototype with 82 PostgreSQL-backed tests.
...
- **No fabricated numbers.** Only claim what the repo actually proves
  (current: 82 PostgreSQL-backed tests, configurable scenario engine,
...
- **Backend tests must stay green.** 82/82 on real Postgres is the floor.
