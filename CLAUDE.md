...
> prototype with 119 PostgreSQL-backed tests.
...
- **No fabricated numbers.** Only claim what the repo actually proves
  (current: 119 PostgreSQL-backed tests, configurable scenario engine,
...
- **Backend tests must stay green.** 119/119 on real Postgres is the floor.
