...
> prototype with 47 PostgreSQL-backed tests.
...
- **No fabricated numbers.** Only claim what the repo actually proves
  (current: 47 PostgreSQL-backed tests, configurable scenario engine,
...
- **Backend tests must stay green.** 47/47 on real Postgres is the floor.
