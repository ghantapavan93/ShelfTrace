...
> prototype with 407 PostgreSQL-backed tests.
...
- **No fabricated numbers.** Only claim what the repo actually proves
  (current: 407 PostgreSQL-backed tests, configurable scenario engine,
...
- **Backend tests must stay green.** 407/407 on real Postgres is the floor.
