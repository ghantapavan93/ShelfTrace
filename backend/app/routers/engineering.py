...
# Dated snapshot — label in UI says "Verification snapshot, not live retailer tests"
...
TEST_PROOF = {
    ...
    "tests": [
        ...
        "tests/test_pricing.py::test_elasticity_recovers_known_beta_clean_data",
        "tests/test_pricing.py::test_elasticity_recovers_inelastic_demand",
        "tests/test_pricing.py::test_elasticity_handles_insufficient_data",
        "tests/test_pricing.py::test_elasticity_handles_zero_price_variance",
        "tests/test_pricing.py::test_elasticity_excludes_promotions_by_default",
        "tests/test_pricing.py::test_elasticity_flags_veblen_when_beta_positive",
        "tests/test_pricing.py::test_predict_quantity_inverse_of_fit",
        "tests/test_pricing.py::test_optimizer_closed_form_matches_calculus",
        "tests/test_pricing.py::test_optimizer_returns_none_for_inelastic_beta",
        "tests/test_pricing.py::test_optimizer_returns_none_for_positive_beta",
        "tests/test_pricing.py::test_optimizer_returns_none_for_degenerate_inputs",
        "tests/test_pricing.py::test_cost_floor_lifts_below_margin_floor",
        "tests/test_pricing.py::test_perishable_urgency_forces_markdown_when_deadline_near",
        "tests/test_pricing.py::test_perishable_urgency_no_op_when_deadline_far",
        "tests/test_pricing.py::test_kvi_lock_clamps_to_competitor_tolerance",
        "tests/test_pricing.py::test_competitor_ceiling_for_non_kvi",
        "tests/test_pricing.py::test_shock_cap_limits_change_to_25_pct_of_current",
        "tests/test_pricing.py::test_inventory_cap_raises_price_when_stockout_risk",
        "tests/test_pricing.py::test_recent_change_suppresses_when_within_window",
        "tests/test_pricing.py::test_recent_change_no_suppress_when_past_window",
        "tests/test_pricing.py::test_pipeline_recommends_lower_price_for_elastic_demand",
        "tests/test_pricing.py::test_pipeline_holds_price_with_insufficient_history",
        "tests/test_pricing.py::test_pipeline_holds_when_cost_missing",
        "tests/test_pricing.py::test_pipeline_suppresses_recent_change",
        "tests/test_pricing.py::test_pipeline_forces_perishable_markdown",
        "tests/test_pricing.py::test_pipeline_kvi_falls_back_to_competitor_when_no_history",
...
def engineering(
    ...
    pipeline = [
        ...
        {"stage": "Outbox Drain (inline)", "status": "done", "detail": "Drained inline via orchestrator; Redis worker available for self-hosted deployments."},
    ...
    shared_engine_statement = (
        ...
        "outbox delivery (inline, Redis-modeled) to typed POS/ESL/ecommerce adapters, deterministic reconciliation, "
